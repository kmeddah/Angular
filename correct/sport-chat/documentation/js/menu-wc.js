                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/ChatModule.html" data-type="entity-link">ChatModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ChatModule-1b0ac560caf88d4d7ee0629ce189db21"' : 'data-target="#xs-components-links-module-ChatModule-1b0ac560caf88d4d7ee0629ce189db21"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ChatModule-1b0ac560caf88d4d7ee0629ce189db21"' :
                                            'id="xs-components-links-module-ChatModule-1b0ac560caf88d4d7ee0629ce189db21"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/ScreenModule.html" data-type="entity-link">ScreenModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ScreenModule-486dee033918d98bef189dde373f6665"' : 'data-target="#xs-components-links-module-ScreenModule-486dee033918d98bef189dde373f6665"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ScreenModule-486dee033918d98bef189dde373f6665"' :
                                            'id="xs-components-links-module-ScreenModule-486dee033918d98bef189dde373f6665"' }>
                                            <li class="link">
